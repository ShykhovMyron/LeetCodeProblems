...
# </pre>
#
# <div><div>Related Topics</div><div><li>Database</li></div></div><br><div><li>👍 168</li><li>👎 2</li></div>

# There is no code of Java type for this problem
SELECT user_id, MAX(time_stamp) AS last_stamp
FROM logins
WHERE time_stamp BETWEEN '2019-12-31 23:59:59' AND '2020-12-31 23:59:59'
GROUP BY user_id